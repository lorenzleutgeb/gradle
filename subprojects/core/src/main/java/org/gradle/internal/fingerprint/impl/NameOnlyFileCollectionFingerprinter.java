...
public class NameOnlyFileCollectionFingerprinter extends AbstractFileCollectionFingerprinter {
    ...
    public NameOnlyFileCollectionFingerprinter(DirectorySensitivity directorySensitivity, FileCollectionSnapshotter fileCollectionSnapshotter, SnapshotHashCodeNormalizer snapshotHashCodeNormalizer) {
        super(new NameOnlyFingerprintingStrategy(directorySensitivity, snapshotHashCodeNormalizer), fileCollectionSnapshotter);
    }
